...
class CustomNautilusMenu(GObject.GObject, Nautilus.MenuProvider):
    ...
    def get_file_items(self, files: List[Nautilus.FileInfo]) -> List[Nautilus.MenuItem]:
        # self.generate_terminal_menu(files, False) + \
        return  self.generate_vscode_menu(files, False) + \
    ...
    def get_background_items(self, current_folder: Nautilus.FileInfo) -> List[Nautilus.MenuItem]:
        # self.generate_terminal_menu([current_folder], True) + \
        return  self.generate_vscode_menu([current_folder], True) + \
